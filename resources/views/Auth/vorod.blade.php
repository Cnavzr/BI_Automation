                ...
                <div class="row justify-content-center h-100">
                    <div class="col-lg-6 py-lg-5">
                        <div class="d-flex flex-column h-100 justify-content-center">
                            ...
                            <p class="text-muted mt-1 mb-4">سامانه پیش ثبت نام مجتمع فرهیختگان سراج</p>
                            ...
                            <div class="mb-2">
                                ...
                                @endif
                                <form method="post" action="{{route('sendVorodCode')}}" class="authentication-form" id="otp-form">
                                    @csrf
                                    <div class="mb-3">
                                        ...
                                        <small class="text-danger">(فقط با شماره موبایلی که به آن پیامک ثبت نام ارسال شده است وارد شوید)</small>

                                    </div>
                                    <div class="mb-1 text-center d-grid">
                                        <button class="btn btn-primary" type="submit">دریافت کد تایید</button>
                                        <p class="mt-2 text-danger">درصورت وجود هرگونه مشکل، می توانید با شماره <a href="tel:02144713982">مجتمع فرهیختگان سراج</a> در ارتباط باشید.</p>
